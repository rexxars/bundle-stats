...
`@rexxars/bundle-stats` measures bundle sizes, bundled-with-deps sizes, and import times for npm package exports. It outputs reports as terminal tables, Markdown, or JSON, and can compare against a baseline to show deltas. Designed for CI workflows that post PR comments with significant size changes.
